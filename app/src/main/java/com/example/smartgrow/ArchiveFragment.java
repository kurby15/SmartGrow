...
public class ArchiveFragment extends Fragment implements CommunityPostAdapter.OnPostInteractionListener {
    ...
    public void onMoreClick(View v, CommunityPostModel post) {
        ...
        // Change Archive to Unarchive for the text
        TextView tvArchive = sheetView.findViewById(R.id.item_archive_post).findViewById(android.R.id.text1);
        if (tvArchive != null) tvArchive.setText("Restore to Feed");
        // Actually, my XML didn't use android.R.id.text1. Let's find it.
        ...
        // Hide edit for simplicity in archive
