...
public class AllPlantsActivity extends AppCompatActivity {
    ...
    private ListenerRegistration plantsListener; // 🔴 Real-time listener handle
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvAllPlantList = findViewById(R.id.rv_all_plant_list);
        etSearchAllPlants = findViewById(R.id.et_search_all_plants);
        layoutViewLess = findViewById(R.id.layout_view_less);

        if (layoutViewLess != null) {
            layoutViewLess.setOnClickListener(v -> finish());
        }

        setupRecyclerView();
        setupSearch();
        listenToAllPlants(); // 🔴 Replaced fetchAllPlants with real-time listener
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        // 🔴 Detach listener when activity is destroyed to avoid memory leaks
    ...
    private void setupRecyclerView() {
        adapter = new MyGardenPlantAdapter(plantList, new MyGardenPlantAdapter.OnPlantClickListener() {
            ...
            public void onAddReminderClick(MyGardenPlantModel plant) {
                Toast.makeText(AllPlantsActivity.this, "Add reminder for " + plant.getPlantName(), Toast.LENGTH_SHORT).show();
            }
        ...
        rvAllPlantList.setLayoutManager(new GridLayoutManager(this, 2));
    ...
    // 🔴 Listens to changes in real-time from Firestore
        ...
        plantsListener = db.collection("diary")
                ...
                .addSnapshotListener((value, error) -> {
                    ...
                    if (value != null) {
                        ...
                        // Re-apply filter if text was typed in search input
    ...
    private void showNamePlantBottomSheet(String currentName, List<String> suggestions, PlantNameBottomSheetFragment.OnPlantNameUpdatedListener updateListener) {
        ...
        bottomSheet.show(getSupportFragmentManager(), "PlantNameBottomSheet");
    }
    ...
    private void deletePlantFromFirestore(String documentId, String plantName) {
        ...
        db.collection("diary").document(documentId)
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(this, "Removed " + (plantName != null ? plantName : "item"), Toast.LENGTH_SHORT).show();
                });
    }
}