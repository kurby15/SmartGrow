...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof UserMessageViewHolder) {
            ...
            // --- Dynamic Follow-Up Suggestions UI Population ---
            if (aiHolder.chipGroupSuggestions != null) {
                aiHolder.chipGroupSuggestions.removeAllViews(); // Reset recycled instances
                ...
                if (suggestions != null && !suggestions.isEmpty()) {
                    ...
                    for (String textQuestion : suggestions) {
                        ...
                        // Bridge back layout transaction to main context execution routine
    ...
    public static class AiMessageViewHolder extends RecyclerView.ViewHolder {
        final TextView tvMessageText, tvMessageTime;
        final ChipGroup chipGroupSuggestions; // Reference inside layout file
